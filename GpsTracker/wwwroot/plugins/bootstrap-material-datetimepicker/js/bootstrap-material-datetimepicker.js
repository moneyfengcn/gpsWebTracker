(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'en', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: '取消', okText: '确定', clearText: '清除', nowText: '现在', switchOnClick: false};
